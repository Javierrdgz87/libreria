...
@section('title', 'Dashboard | Agregar Libro')
			     	...
			     	<div class="row">
				      	...
				      	<div class="col-md-4">
				      		<div class="form-group">
							    ...
							    <input type="text" class="form-control" id="tAutor" name="tAutor" placeholder="Autor" value="{{ old('tAutor') }}">
							</div>
		      			</div>
				      	<div class="col-md-4">
				      		<div class="form-group">
							    <label for="eCodCategoria">Categoria</label>
							    <input type="text" class="form-control" id="eCodCategoria" name="eCodCategoria" placeholder="Categoria" value="{{ old('eCodCategoria') }}">
							</div>
		      			</div>
		      		</div>
		    	</div>
